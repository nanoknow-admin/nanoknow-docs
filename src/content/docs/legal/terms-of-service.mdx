...
<Section title='<span style="color: var(--color-lightmode-primary);">Terms of</span> <span style="color: var(--color-primary);">Service</span>' description="" titleClass="text-7xl">
